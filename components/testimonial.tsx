      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative min-h-[200px] flex items-center justify-center">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div>
                  <p className="text-sm tracking-wide text-primary-foreground/90 font-medium">
                    {testimonial.author}
                  </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-12">
            <button
              onClick={prev}
              className="w-10 h-10 rounded-full border border-primary-foreground/30 flex items-center justify-center text-primary-foreground transition-all duration-300 hover:bg-primary-foreground/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground"
            ...
            <div className="flex gap-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground ${

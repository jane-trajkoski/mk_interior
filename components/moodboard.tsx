      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light text-foreground mb-4">
            Moodboard&apos;s inspiration
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Discover the aesthetic directions that inspire our work. Each moodboard captures a distinct design
            philosophy.
          </p>
        </div>
